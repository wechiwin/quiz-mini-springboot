...
//
// public class WrapperBuilderUtilOld {
//
//     private static final String DOT = ".";
//
//     /**
//      * 根据QueryDto构造QueryWrapper<br>
//      *
...
//         // 构造field
//         buildExtendFields(wrapper, queryDto);
//         // 构造field order
//         buildExtendOrders(queryDto, new WrapperOrderProvider(wrapper));
//
//         return wrapper;
//     }
//
...
//      * @return
//      */
//     private static void buildExtendFields(QueryWrapper wrapper, QueryDTO queryDto) {
//
...
//      * @param provider
//      */
//     private static void buildExtendOrders(QueryDTO queryDto, OrderProvider provider) {
...
//
//
//     private static <T> void buildQueryField(QueryWrapper<T> wrapper, String[] fields, Object fieldValue, QueryOp op) {
//         if (fields.length == 1) {
...
//      * @return
//      */
//     protected static <T> QueryWrapper<T> buildOrQueryFields(QueryWrapper<T> wrapper, String[] fields, Object value, QueryOp op) {
...
//      * @return
//      */
//     protected static <T> QueryWrapper<T> buildOrQueryValues(QueryWrapper<T> wrapper, String field, Collection values, QueryOp op) {
...
//      * @param op
//      */
//     private static AbstractWrapper buildSingleQueryField(AbstractWrapper wrapper, String field, Object val, QueryOp op) {
//
//         // 以sql表示（下划线）的列名
...
//      * @return
//      */
//     private static Object handleEndValue(Object endValue) {
//         if (endValue == null) {
//             return endValue;
//         }
//
...
//      * @return
//      */
//     private static Set removeDuplicate(Collection list) {
//         if (list == null) {
//             return new HashSet();
//         }
//
